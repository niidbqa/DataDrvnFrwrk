package com.ebafni.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "samdav270@gmail.com";
	public static String password = "Kenya123";
	public static String[] to ={"niidbqa@gmail.com","dzewuqa@gmail.com"};
